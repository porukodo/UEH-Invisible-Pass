    ...
    <div className="flex flex-col gap-6 p-4 pb-24">
      ...
      >
        ...
        <div className="relative z-10 space-y-4">
          <p className="text-sm text-white/70 font-medium">Số dư khả dụng ({user?.fullName})</p>
          <h2 className="text-4xl font-bold tracking-tight">{Number(balance).toLocaleString('vi-VN')} đ</h2>
